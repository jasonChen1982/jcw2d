function Renderer(view, options) {
  ...
  if (options) {
    for (let i in JC.CONST.DEFAULT_RENDER_OPTIONS) {
...
Renderer.prototype._createContext = function() {
  let gl = this.view.getContext('webgl', this._contextOptions) || this.view.getContext('experimental-webgl', this._contextOptions);
  this.gl = gl;
