...
Shader.prototype.compile = function() {
  ...
  let glVertShader = this._glCompile(gl.VERTEX_SHADER, this.vertexSrc);
  let glFragShader = this._glCompile(gl.FRAGMENT_SHADER, this.fragmentSrc);
...
Shader.prototype.initSampler2D = function(uniform) {
  ...
  let texture = uniform.value.baseTexture;
