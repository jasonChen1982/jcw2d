 ...
 *
 * @param {PIXI.StencilMaskStack} stencilMaskStack The mask stack
 */
...
WebGLMaskManager.prototype.bindGraphics = function(graphics, webGLData) {
  ...
  let shader;// = this.renderer.shaderManager.plugins.primitiveShader;
 ...
 *
 * @param {any[]} maskData The mask data structure to use
 */
...
export default WebGLMaskManager;
