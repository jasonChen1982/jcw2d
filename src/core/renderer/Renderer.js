 ...
 * @param {boolean} [options.preserveDrawingBuffer=false] enables drawing buffer preservation, enable this if
...
// utils.pluginTarget.mixin(Renderer);
 ...
 *
 * @param {PIXI.DisplayObject} object the object to be rendered
 */
 ...
 * @param {PIXI.RenderTarget} renderTarget The render target to use to render this display object
 * @param {booleab} clear The render target to use to render this display object
 *
 */
Renderer.prototype.renderDisplayObject = function(displayObject, renderTarget, clear) {
  // TODO is this needed...
 ...
 * @param {boolean} _skipRemove the texture to destroy
 */
